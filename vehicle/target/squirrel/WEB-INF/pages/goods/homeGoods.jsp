    ...
    <nav class="white nav1">
        <div class="nav-wrapper">
            <a href="<%=basePath%>goods/homeGoods" class="logo">
                <img src="<%=basePath%>img/logo.png"  height="80%" />
                <em class="em3">二手电瓶车估值网站</em>
            </a>
                    ...
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到二手电瓶车估价网</p>
                                <p class="text3">你，是否有二手电瓶车买卖的需求呢</p>
                                <p class="text4">务，我们打造了一个全新的二手估值平台——<span>二手电瓶车估值网站</p>
                                <p class="text5">这里有更多的二手电瓶车分享，更自由的交易估值中心，你想要的，都在这里。</p>
                                <p class="text6">加入您应更精彩。</p>
                            </ul>
                          <!--   <div class="logoimg">
