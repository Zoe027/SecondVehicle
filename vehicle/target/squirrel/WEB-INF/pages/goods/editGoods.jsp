        ...
        <div id="user_content">
            <div class="basic">
                <form:form action="../../goods/editGoodsSubmit" method="post" role="form" enctype="multipart/form-data">
                    <h1 style="margin-left: 210px;">修改二手电瓶车信息</h1><hr />
                    <div class="changeinfo">
                        <span>二手电瓶车名：</span>
                        <input class="in_info" type="text" name="name" placeholder="请输入二手电瓶车名" value="${goodsExtend.goods.name}"/>
                        <span>(*必填)</span>
                    </div>
                    <div class="changeinfo">
                        <span>出售价格：</span>
                   ...
                   <div class="changeinfo">
                        <span>原价：</span>
                        <input class="in_info" type="text" name="realPrice" placeholder="请输入电瓶车原价" value="${goodsExtend.goods.realPrice}"/>
