				...
				<div class="home_nav">
					<ul>
						...
						<a href="<%=basePath%>goods/publishGoods">
							<li class="store">
								<div></div> <span>发布二手电瓶车</span> <strong></strong>
						</li>
						</a>
						<a href="<%=basePath%>user/allGoods">
							<li class="second">
								<div></div> <span>我的二手电瓶车</span> <strong></strong>
						</li>
						</a>
						...
						<div class="story">
							...
							<h4 >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;订单编号： <input name="orderNum" class="order-num" type="text" style="border:0px;background:rgba(0, 0, 0, 0);" value=""/>  <input name="goodsId" type="hidden" value="${goodsExtend.goods.id}"/> </h4>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="orderAddress"  class="form-control" style="border:0px;background:rgba(0, 0, 0, 0);"  >
									       <option value='1号公寓'>1号公寓</option>
									       <option value='2号公寓'>2号公寓</option>
										   <option value='3号公寓'>3号公寓</option>
										   <option value='4号公寓'>4号公寓</option>
										   <option value='5号公寓'>5号公寓</option>
										   <option value='6号公寓'>6号公寓</option>
										   <option value='7号公寓'>7号公寓</option>
										   <option value='8号公寓'>8号公寓</option>
										   <option value='9号公寓'>9号公寓</option>
