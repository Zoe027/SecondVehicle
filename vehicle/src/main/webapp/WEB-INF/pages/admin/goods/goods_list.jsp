		...
		<div id="content-header">
			<div id="breadcrumb">
				<a href="<%=basePath%>admin/indexs" title="主页"
					class="tip-bottom"><i class="icon-home"></i>主页</a> <a title="电瓶车列表"
					class="tip-bottom">电瓶车列表</a>
			</div>
		</div>
		<!--End-breadcrumbs-->
		...
		<div class="container" style="width: 1000px;">
			...
			<!--搜索栏-->
			 <form class="form-horizontal" id="myserchform" name="myform" action="<%=basePath%>admin/searchGoods" method="post">
				...
				<div  class="col-sm-8" style="text-align:center;">
					...
					<option value="" selected="selected">选择电瓶车状态</option>
			...
			<div style="text-align: right">
				<div class="pagination">
					<ul>
						<li><a>总电瓶车数:${goodsGrid.total }个</a></li>
   ...
   <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel" >修改电瓶车信息</h4>
            </div>
...
<div class="modal fade" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel" >查看电瓶车信息</h4>
            </div>
            <div class="modal-body" style="height:0 auto; ">
