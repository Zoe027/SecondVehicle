        ...
        <div id="user_content">
            <div class="basic">
                <form:form action="../goods/publishGoodsSubmit" method="post" role="form" enctype="multipart/form-data">
                    <h1 style="margin-left: 210px;">二手电瓶车估值</h1><hr />
                    ...
                    <div class="changeinfo">
                     ...
                     <input type="button" class="setting-save" value="估价" onclick="getEvaluation()" style="margin-top: 15px;background-color: blue;"/>
                     <div class="changeinfo">
                        <span>估价：</span>
...
<script>
    ...
    function getEvaluation(){
    	...
    	//result = -327.469 +(-59.99)*years+11.73*voltage+59.114*batteryHealth+30.116*numBrokenParts+(-110.804)*size+34.695*overallHealth;
