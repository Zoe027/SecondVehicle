    ...
    <nav class="white nav1">
        <div class="nav-wrapper">
            <a href="<%=basePath%>goods/homeGoods" class="logo">
                <img src="<%=basePath%>img/logo.png" style="float:left; height:100%;" />
                <em style="margin-top:5px;" class="em2">二手电瓶车估值网站</em>
            </a>
            <div class="nav-wrapper search-bar">
                <form class="ng-pristine ng-invalid ng-invalid-required" action="<%=basePath%>goods/search">
                    <div class="input-field">
                        <input id="search" name="str" placeholder="搜点什么吧..." style="height: 40px;width:200px;"
                               class="ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required"/>
                      	<input type="submit" style="height: 35px;" class="btn"value="搜索"></input>
            ...
            <ul class="right">
                ...
                <c:if test="${!empty cur_user}">
                    <li class="publish-btn">
                     ...
                     <li>
                       <a href="<%=basePath%>goods/preGoods">电瓶车估值</a>
                    </li>
                    <li>
                        <a href="<%=basePath%>user/allGoods">我发布的电瓶车</a>
                    </li>
                    <li>
...
<!--
    描述：左侧导航条
-->
<div ng-controller="sidebarController" class="sidebar stark-components ng-scope" style="width:300px;height:800px;">
            ...
            <ul class="slides" style="height: 400px;">
                <li class="active" style="opacity: 1;">
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                <p class="text1">欢迎来到二手电瓶车估价网</p>
                                <p class="text2">你，是否有二手电瓶车买卖的需求呢</p>
                                <p class="text3"> ~~~~~~~~~~~~~~~~~~~~~~~</p>
                                <p class="text4">我们打造了一个全新的二手估值平台——<span>二手电瓶车估值网</p>
                                <p class="text5">这里有更多的二手电瓶车分享，更自由的交易估值中心</p>
